...
; Calculation the initial percentage of corrupt people
to calc
  set prct Percentage / 100
end

; Calculation and setup of the initial good people
to pop_good
  set ngood floor Population * ( 1 - prct)
  create-turtles ngood [
    set shape "person";
    set color green;
...
; Calculation and setup of the initial corrupt people
to pop_bad
  set nbad floor Population * prct
  create-turtles nbad [
   set shape "person";
   set color red;
   setxy random-xcor random-ycor;
